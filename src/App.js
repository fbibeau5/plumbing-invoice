...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ CALENDRIER ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
const CAL_DAYS   = ['Lun','Mar','Mer','Jeu','Ven','Sam','Dim'];
const CAL_MONTHS = ['Janvier','FÃÂÃÂ©vrier','Mars','Avril','Mai','Juin','Juillet','AoÃÂÃÂ»t','Septembre','Octobre','Novembre','DÃÂÃÂ©cembre'];
const EV_COLORS  = { scheduled:'#1a6bb5', completed:'#16a34a', cancelled:'#c0392b', pending:'#d97706' };
const EV_LABELS  = { scheduled:'PlanifiÃÂÃÂ©', completed:'ComplÃÂÃÂ©tÃÂÃÂ©', cancelled:'AnnulÃÂÃÂ©', pending:'En attente' };
...
- "qty": quantity as a decimal number (float) - preserve fractions exactly. "2.5 longueurs" ÃÂ¢ÃÂÃÂ 2.5
...
- "valve antibelier uponor" ÃÂ¢ÃÂÃÂ code 4044, confidence 1.0
- "valve antibelier" ÃÂ¢ÃÂÃÂ code 4043, confidence 1.0
- "valve angle" ÃÂ¢ÃÂÃÂ code 4034 or 4069 only
- "valve droite" ÃÂ¢ÃÂÃÂ code 4035 or 4070 only
- The first item in "matches" is always your best guess`;
  ...
  if (!data.content || !Array.isArray(data.content)) throw new Error("RÃÂÃÂ©ponse invalide: " + JSON.stringify(data));
...
- 4x coude 45 1.5"  
- 2x TY 1.5"
- 1x P-trap collÃÂÃÂ©e 1.5"
- 3x coupling 2"
- 1x tuyau 12' 2"

Finition:
- 2x valve antibÃÂÃÂ©lier UPONOR
- 1x beigne cire toilette jumbo
- 2x bolt toilette plastique
- 1x flange chromÃÂÃÂ©e
- 1x p-trap ajustable
...
const THEMES = {
  ...
  light: {
    name: "ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ Clair",
...
export default function App() {
  ...
  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ HORAIRE STATE ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  ...
  const saveToHistory = (items, client, job, num, bonus = 0) => {
    ...
    }).catch(() => {}); // hors-ligne : sauvegardÃÂÃÂ© localement quand mÃÂÃÂªme
  };
  ...
  const saveCustomProduct = () => {
    ...
    if (!cost || cost <= 0) return setAddError('CoÃÂÃÂ»t invalide');
    if (PRODUCTS[code] || customProducts[code]) return setAddError('Ce code existe dÃÂÃÂ©jÃÂÃÂ ');
  ...
  const saveEdit = (code) => {
    ...
    // overrideMargin is stored as a percentage string (e.g. "25" = 25%) ÃÂ¢ÃÂÃÂ divide by 100 to get decimal
  ...
  const saveToWeeklyReport = async () => {
    ...
    try {
      ...
      setSaveStatus('ÃÂ¢ÃÂÃÂ AjoutÃÂÃÂ© au rapport de la semaine!');
    } catch(e) {
      // Server sync failed but local backup succeeded
      setSaveStatus('ÃÂ¢ÃÂÃÂ SauvegardÃÂÃÂ© localement (synchro hors ligne)');
    }
    setTimeout(() => setSaveStatus(null), 3000);
  };

  const printInvoice = () => {
    // Le sous-total PDF inclut silencieusement la marge bonus (non affichÃÂÃÂ©e au client)
    ...
    const html = `<!DOCTYPE html><html><head>
      ...
      <div class="top">
        <div class="top-logo"><img src="${logoUrl}" alt="RÃÂÃÂ©volution Plomberie"/></div>
        <div class="top-info">
      ...
      <div class="section-title">Ventilation des matÃÂÃÂ©riaux</div>
      <table>
        <thead><tr>
          <th>Article</th><th>Dim.</th>
          <th style="text-align:center">QtÃÂÃÂ©</th>
    ...
    // Iframe invisible ÃÂ¢ÃÂÃÂ seule mÃÂÃÂ©thode fiable sur iOS Safari
  ...
  // Refs pour les timers de retry (ÃÂÃÂ©vite les fuites mÃÂÃÂ©moire)
  const catalogRetryRef  = useRef(null);
  const historyRetryRef  = useRef(null);
  const scheduleRetryRef = useRef(null);

  // Sync catalogue ÃÂ¢ÃÂÃÂ serveur = source de vÃÂÃÂ©ritÃÂÃÂ© (multi-utilisateurs)
  ...
  // Sync historique ÃÂ¢ÃÂÃÂ fusion serveur + local
    ...
    fetch('/api/history-data')
      ...
      .then(serverHistory => {
        ...
        setListHistory(prev => {
          ...
          // EntrÃÂÃÂ©es locales absentes du serveur ÃÂ¢ÃÂÃÂ on les pousse au serveur
  ...
  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ SYNC HORAIRE ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  ...
  // Pad de signature ÃÂ¢ÃÂÃÂ dessin sur canvas
  ...
  const sendEventReminder = async (ev, type = 'reminder') => {
    if (!ev.clientEmail) {
      alert('Aucun courriel client enregistrÃÂÃÂ© pour ce rendez-vous.');
      return;
    }
  ...
  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ LOGIN SCREEN ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  if (!authed) return (
    <div style={{ minHeight: '100vh', background: '#0f1628', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'system-ui,-apple-system,sans-serif', position: 'relative' }}>
      ...
      <div style={{ position: 'relative', zIndex: 1, background: '#1e2a4a', border: '1px solid #2d3d6a', borderRadius: 16, padding: '40px 32px', width: '100%', maxWidth: 360, textAlign: 'center', boxShadow: '0 20px 60px rgba(0,0,0,0.5)' }}>
        <img src={process.env.PUBLIC_URL + '/logo.svg'} alt="RÃÂÃÂ©volution Plomberie" style={{ width: 140, margin: '0 auto 24px', display: 'block', filter: 'brightness(0) invert(1)' }} />
        <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.4)', letterSpacing: 2, marginBottom: 32 }}>ACCÃÂÃÂS SÃÂÃÂCURISÃÂÃÂ</div>
        <input
          type="password"
          value={pwInput}
        ...
        <button onClick={handleLogin} style={{ width: '100%', padding: 14, background: '#1a6bb5', border: 'none', borderRadius: 10, color: 'white', fontSize: 16, fontWeight: 700, fontFamily: 'inherit', cursor: 'pointer', marginTop: 8 }}>
          Connexion ÃÂ¢ÃÂÃÂ
        </button>
      </div>
    </div>
  );

  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ MOBILE LAYOUT ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  if (isMobile && mobileView === 'mobile') {
    const mTabs = [
      { id: 'parse',    icon: 'ÃÂ°ÃÂÃÂÃÂ', label: 'Notes' },
      { id: 'invoice',  icon: 'ÃÂ°ÃÂÃÂÃÂ¦', label: `Liste (${invoiceItems.length})` },
      { id: 'schedule', icon: 'ÃÂ°ÃÂÃÂÃÂ', label: 'Horaire' },
      { id: 'catalog',  icon: 'ÃÂ°ÃÂÃÂÃÂÃÂ¯ÃÂ¸ÃÂ', label: 'Catalogue' },
      { id: 'history',  icon: 'ÃÂ°ÃÂÃÂÃÂ', label: 'Historique' },
      { id: 'margins',  icon: 'ÃÂ°ÃÂÃÂÃÂ', label: 'Marges' },
    ];
    ...
    return (
      <div style={{ minHeight: '100vh', background: C.bg, fontFamily: 'system-ui,-apple-system,sans-serif', color: C.text, paddingBottom: 'calc(72px + env(safe-area-inset-bottom))' }}>
        ...
        <div style={{ background: C.header, padding: '12px 16px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'sticky', top: 0, zIndex: 50, boxShadow: '0 2px 8px rgba(0,0,0,0.2)' }}>
          <img src={process.env.PUBLIC_URL + '/logo.svg'} alt="RÃÂÃÂ©volution Plomberie" style={{ height: 36, filter: 'brightness(0) invert(1)', display: 'block' }} />
          <div className="no-print" style={{ display: 'flex', gap: 8 }}>
            <button onClick={() => setShowThemes(p => !p)} style={{ padding: '6px 10px', background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.2)', borderRadius: 6, color: 'white', cursor: 'pointer', fontSize: 16 }}>ÃÂ°ÃÂÃÂÃÂ¨</button>
            <button onClick={() => setMobileView('desktop')} style={{ padding: '6px 10px', background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.2)', borderRadius: 6, color: 'white', cursor: 'pointer', fontSize: 12, fontWeight: 600 }}>ÃÂ°ÃÂÃÂÃÂ¥ÃÂ¯ÃÂ¸ÃÂ</button>
            <button onClick={() => { localStorage.removeItem('plomb_auth'); setAuthed(false); }} style={{ padding: '6px 10px', background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.2)', borderRadius: 6, color: 'white', cursor: 'pointer', fontSize: 12 }}>ÃÂ°ÃÂÃÂÃÂ</button>
          </div>
          {showThemes && (
        ...
        <div style={{ padding: '16px 14px' }}>
          ...
          {tab === 'parse' && (
            <div>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
                <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: 1.5, color: C.accent, textTransform: 'uppercase' }}>Coller la liste de matÃÂÃÂ©riaux</div>
                {notesText.trim() && (
                  <button onClick={() => setNotesText('')} style={{ padding: '5px 12px', background: 'transparent', border: `1px solid ${C.border}`, borderRadius: 6, color: C.textMuted, cursor: 'pointer', fontFamily: 'inherit', fontSize: 12, WebkitTapHighlightColor: 'transparent', touchAction: 'manipulation' }}>ÃÂ°ÃÂÃÂÃÂÃÂ¯ÃÂ¸ÃÂ Effacer</button>
                )}
              </div>
              <textarea
                value={notesText}
              ...
              <button onClick={handleParse} disabled={parsing} style={{ marginTop: 12, width: '100%', padding: 18, background: parsing ? C.textLight : C.accent, border: 'none', borderRadius: 12, color: 'white', fontSize: 17, fontFamily: 'inherit', cursor: parsing ? 'not-allowed' : 'pointer', fontWeight: 700, WebkitTapHighlightColor: 'transparent', touchAction: 'manipulation' }}>
                {parsing ? 'ÃÂ¢ÃÂÃÂ³ Analyse en cours...' : 'ÃÂ¢ÃÂÃÂ¡ Analyser avec l\'IA'}
              </button>
              ...
              {pendingReview.length > 0 && (
                <div style={{ marginTop: 20 }}>
                  <div style={{ fontSize: 14, fontWeight: 700, color: '#e67e22', marginBottom: 12 }}>
                    ÃÂ¢ÃÂÃÂ ÃÂ¯ÃÂ¸ÃÂ {pendingReview.length} item{pendingReview.length > 1 ? 's' : ''} ÃÂÃÂ  confirmer
                  </div>
                  {pendingReview.map(r => (
                    <div key={r.id} style={{ background: C.card, border: '2px solid #e67e22', borderRadius: 12, padding: 14, marginBottom: 12 }}>
                      ...
                      <div style={{ fontSize: 12, color: C.textMuted, marginBottom: 12 }}>QtÃÂÃÂ©: <strong>{r.qty}</strong> ÃÂÃÂ· Confiance: <strong style={{ color: '#e67e22' }}>{Math.round(r.confidence * 100)}%</strong></div>
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                        {r.matches.slice(0, 3).map((m, idx) => (
                          <button key={m.code} onClick={() => confirmReviewItem(r.id, m.code)} style={{ padding: '12px 14px', background: idx === 0 ? C.accent + '18' : C.inputBg, border: `2px solid ${idx === 0 ? C.accent : C.border}`, borderRadius: 10, cursor: 'pointer', fontFamily: 'inherit', textAlign: 'left' }}>
                            ...
                            <div style={{ fontSize: 12, color: C.textMuted }}>#{m.code} ÃÂÃÂ· {m.product.dim} ÃÂÃÂ· <strong style={{ color: C.accent }}>{fmt(m.product.sell)}</strong></div>
                          </button>
                        ))}
                  ...
                  {invoiceItems.length > 0 && (
                    <button onClick={() => { setPendingReview([]); setTab('invoice'); }} style={{ width: '100%', padding: 14, background: C.accent, border: 'none', borderRadius: 10, color: 'white', cursor: 'pointer', fontFamily: 'inherit', fontSize: 14, fontWeight: 700 }}>
                      Voir la liste ({invoiceItems.length} items) ÃÂ¢ÃÂÃÂ
                    </button>
                  )}
                </div>
              )}
            ...
            <div>
              ...
              {invoiceItems.length === 0 ? (
                <div style={{ textAlign: 'center', padding: '40px 20px', color: C.textLight, fontSize: 14 }}>
                  Aucun article ÃÂ¢ÃÂÃÂ analysez vos notes ou ajoutez depuis le catalogue
                </div>
              ) : (
                  ...
                  {invoiceItems.map((item, idx) => (
                    <div key={item.id} style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 10, padding: '12px 14px', display: 'flex', alignItems: 'center', gap: 12 }}>
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <div style={{ fontSize: 11, color: C.textMuted }}>{item.product.dim} ÃÂÃÂ· <span style={{ color: CAT_COLORS[item.product.category], fontWeight: 600 }}>{item.product.category}</span></div>
                      </div>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 }}>
                        <div style={{ textAlign: 'right' }}>
                          <div style={{ fontSize: 13, fontWeight: 700, color: C.accent }}>{fmt(item.qty * item.product.sell)}</div>
                          <div style={{ fontSize: 11, color: C.textMuted }}>{fmt(item.product.sell)} ÃÂÃÂ </div>
                        </div>
                        <input
                        ...
                        />
                        <button onClick={() => removeItem(item.id)} style={{ background: 'none', border: 'none', color: '#e74c3c', cursor: 'pointer', fontSize: 20, padding: '4px', lineHeight: 1 }}>ÃÂ¢ÃÂÃÂ</button>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 12, padding: 16, marginBottom: 12 }}>
                ...
                {margeBonus > 0 && (
                  <div style={{ display: 'flex', justifyContent: 'space-between', padding: '6px 0', borderBottom: `1px solid ${C.rowBorder}`, fontSize: 14, color: '#16a34a', fontWeight: 600 }}>
                    <span>ÃÂ°ÃÂÃÂÃÂ Marge +{Math.round(margeBonus * 100)}%</span><span>+{fmt(bonusAmount)}</span>
                  </div>
                )}
              ...
              <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 12, padding: 14, marginBottom: 16 }}>
                <div style={{ fontSize: 11, fontWeight: 700, color: C.textMuted, marginBottom: 10, textTransform: 'uppercase', letterSpacing: 1 }}>ÃÂ°ÃÂÃÂÃÂ Bonification de marge (interne)</div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                ...
                <button onClick={saveToWeeklyReport} disabled={invoiceItems.length === 0} style={{ padding: 15, background: invoiceItems.length === 0 ? C.inputBg : '#16a34a', border: 'none', borderRadius: 10, color: invoiceItems.length === 0 ? C.textLight : 'white', cursor: invoiceItems.length === 0 ? 'not-allowed' : 'pointer', fontFamily: 'inherit', fontSize: 15, fontWeight: 700 }}>
                  ÃÂ°ÃÂÃÂÃÂ Ajouter au rapport semaine
                </button>
                <button onClick={handleSaveInvoice} disabled={invoiceItems.length === 0} style={{ padding: 15, background: invoiceItems.length === 0 ? C.inputBg : (invoiceSaved ? '#16a34a' : '#0f4c8a'), border: 'none', borderRadius: 10, color: invoiceItems.length === 0 ? C.textLight : 'white', cursor: invoiceItems.length === 0 ? 'not-allowed' : 'pointer', fontFamily: 'inherit', fontSize: 15, fontWeight: 700, transition: 'background 0.3s' }}>
                  {invoiceSaved ? 'ÃÂ¢ÃÂÃÂ SauvegardÃÂÃÂ© !' : 'ÃÂ°ÃÂÃÂÃÂ¾ Sauvegarder la facture'}
                </button>
                <button onClick={printInvoice} style={{ padding: 15, background: C.accent, border: 'none', borderRadius: 10, color: 'white', cursor: 'pointer', fontFamily: 'inherit', fontSize: 15, fontWeight: 700 }}>
                  ÃÂ°ÃÂÃÂÃÂ¨ÃÂ¯ÃÂ¸ÃÂ Imprimer / PDF
                </button>
                {invoiceItems.length > 0 && (
                  <button onClick={() => { if (window.confirm('Effacer la liste actuelle et commencer une nouvelle facture?')) { setInvoiceItems([]); setClientName(''); setJobAddress(''); setJobDesc(''); setInvoiceNum('001'); setMargeBonus(0); setInvoiceSaved(false); setTab('parse'); } }} style={{ padding: 12, background: 'transparent', border: `1px solid ${C.border}`, borderRadius: 10, color: C.textMuted, cursor: 'pointer', fontFamily: 'inherit', fontSize: 13, touchAction: 'manipulation' }}>
                    ÃÂ°ÃÂÃÂÃÂÃÂ¯ÃÂ¸ÃÂ Nouvelle facture
                  </button>
                )}
                {saveStatus && <div style={{ textAlign: 'center', fontSize: 14, fontWeight: 600, color: saveStatus.startsWith('ÃÂ¢ÃÂÃÂ') ? '#16a34a' : '#c0392b' }}>{saveStatus}</div>}
              </div>
            </div>
          )}
          ...
          {tab === 'catalog' && (
            <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
                {catalogSync === 'sync' && <div style={{ fontSize: 11, color: C.textMuted }}>ÃÂ¢ÃÂÃÂ³ Sync catalogueÃÂ¢ÃÂÃÂ¦</div>}
                {catalogSync === 'ok' && <div style={{ fontSize: 11, color: '#16a34a' }}>ÃÂ¢ÃÂÃÂ Catalogue synchronisÃÂÃÂ©</div>}
                {catalogSync === 'offline' && <div style={{ fontSize: 11, color: '#c0392b' }}>ÃÂ°ÃÂÃÂÃÂµ Hors-ligne</div>}
                <button onClick={() => syncCatalog()} disabled={catalogSync === 'sync'} style={{ padding: '5px 10px', background: C.card, border: `1px solid ${C.border}`, borderRadius: 6, color: C.textMuted, cursor: 'pointer', fontFamily: 'inherit', fontSize: 11, touchAction: 'manipulation', opacity: catalogSync === 'sync' ? 0.5 : 1 }}>ÃÂ°ÃÂÃÂÃÂ</button>
              </div>
              ...
              <button onClick={() => { setShowAddForm(p => !p); setAddError(''); }} style={{ width: '100%', padding: '12px', background: showAddForm ? C.accent : C.card, border: `1px solid ${showAddForm ? C.accent : C.border}`, borderRadius: 10, color: showAddForm ? 'white' : C.accent, cursor: 'pointer', fontFamily: 'inherit', fontSize: 14, fontWeight: 700, marginBottom: 12, WebkitTapHighlightColor: 'transparent', touchAction: 'manipulation' }}>
                {showAddForm ? 'ÃÂ¢ÃÂÃÂ Fermer' : 'ÃÂ¢ÃÂÃÂ Nouveau produit'}
              </button>
              ...
              {showAddForm && (
                <div style={{ background: C.card, border: `2px solid ${C.accent}`, borderRadius: 12, padding: 16, marginBottom: 16 }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 12 }}>
                    {[['Code', 'code', 'ex: 5001'], ['Nom', 'name', 'ex: Coude 90 spÃÂÃÂ©cial'], ['Dimension', 'dim', 'ex: 2']].map(([label, field, placeholder]) => (
                      <div key={field}>
                    ...
                    <div>
                      <div style={{ fontSize: 11, fontWeight: 700, color: C.textMuted, marginBottom: 4, textTransform: 'uppercase', letterSpacing: 0.5 }}>CatÃÂÃÂ©gorie</div>
                    ...
                    <div>
                      <div style={{ fontSize: 11, fontWeight: 700, color: C.textMuted, marginBottom: 4, textTransform: 'uppercase', letterSpacing: 0.5 }}>CoÃÂÃÂ»t ($)</div>
                  ...
                  <button onClick={saveCustomProduct} style={{ width: '100%', padding: 14, background: C.accent, border: 'none', borderRadius: 10, color: 'white', cursor: 'pointer', fontFamily: 'inherit', fontSize: 15, fontWeight: 700, WebkitTapHighlightColor: 'transparent', touchAction: 'manipulation' }}>ÃÂ¢ÃÂÃÂ Sauvegarder</button>
                </div>
              )}
                ...
                {filtered.map(p => {
                  ...
                  if (isEditing) return (
                    <div key={p.code} style={{ background: C.card, border: `2px solid ${C.accent}`, borderRadius: 12, padding: 16 }}>
                      <div style={{ fontSize: 12, fontWeight: 700, color: C.accent, marginBottom: 12 }}>ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ MODIFIER #{p.code}</div>
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 12 }}>
                        {[['Nom', 'name', 'text'], ['Dimension', 'dim', 'text'], ['CoÃÂÃÂ»t ($)', 'cost', 'number']].map(([label, field, type]) => (
                          <div key={field}>
                        ...
                        <div>
                          <div style={{ fontSize: 11, fontWeight: 700, color: C.textMuted, marginBottom: 4, textTransform: 'uppercase' }}>CatÃÂÃÂ©gorie</div>
                        ...
                        <div>
                          <div style={{ fontSize: 11, fontWeight: 700, color: C.textMuted, marginBottom: 4, textTransform: 'uppercase' }}>
                            Marge individuelle (%) ÃÂ¢ÃÂÃÂ laisser vide pour catÃÂÃÂ©gorie ({Math.round((categoryMargins[editForm.category] ?? DEFAULT_MARGINS[editForm.category]) * 100)}%)
                          </div>
                          <input type="number" min="1" max="60"
                            placeholder={`${Math.round((categoryMargins[editForm.category] ?? DEFAULT_MARGINS[editForm.category]) * 100)} (catÃÂÃÂ©gorie)`}
                      ...
                      {editForm.cost && parseFloat(editForm.cost) > 0 && (() => {
                        ...
                        return (
                          <div style={{ fontSize: 12, color: C.textMuted, background: C.inputBg, padding: '8px 12px', borderRadius: 8, marginBottom: 12 }}>
                            ...
                            <span style={{ marginLeft: 8 }}>marge: <strong style={{ color: overrideMargin ? '#e67e22' : C.textMuted }}>{Math.round(effectiveMargin * 100)}%{overrideMargin ? ' (individuelle)' : ' (catÃÂÃÂ©gorie)'}</strong></span>
                          </div>
                        );
                      })()}
                      <div style={{ display: 'flex', gap: 8 }}>
                        <button onClick={() => saveEdit(String(p.code))} style={{ flex: 1, padding: 12, background: C.accent, border: 'none', borderRadius: 8, color: 'white', cursor: 'pointer', fontFamily: 'inherit', fontSize: 14, fontWeight: 700, touchAction: 'manipulation' }}>ÃÂ¢ÃÂÃÂ Sauver</button>
                    ...
                    <div key={p.code} style={{ background: C.card, border: `1px solid ${isCustom ? C.accent : C.border}`, borderRadius: 10, padding: '12px 14px' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          <div style={{ fontSize: 11, color: C.textMuted }}>#{p.code} ÃÂÃÂ· {p.dim}</div>
                          <div style={{ fontSize: 11, color: C.textLight }}>coÃÂÃÂ»t: {fmt(p.cost)}</div>
                        </div>
                      ...
                      <div style={{ display: 'flex', gap: 8, marginTop: 10, paddingTop: 10, borderTop: `1px solid ${C.border}` }}>
                        <button onClick={() => startEdit(p)} style={{ flex: 1, padding: '8px', background: C.inputBg, border: `1px solid ${C.border}`, borderRadius: 8, color: C.textMuted, cursor: 'pointer', fontFamily: 'inherit', fontSize: 13, touchAction: 'manipulation' }}>ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ Modifier</button>
                        {isCustom && (
                          <button onClick={() => deleteCustomProduct(String(p.code))} style={{ padding: '8px 16px', background: '#fdecea', border: '1px solid #f5c6c6', borderRadius: 8, color: '#c0392b', cursor: 'pointer', fontFamily: 'inherit', fontSize: 13, touchAction: 'manipulation' }}>ÃÂ¢ÃÂÃÂ Supprimer</button>
                        )}
                      </div>
                    </div>
                  );
            ...
            return (
              <div>
                ...
                <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:12 }}>
                  <button onClick={() => { let m=calMonth-1,y=calYear; if(m<0){m=11;y--;} setCalMonth(m);setCalYear(y);setSelectedDay(null); }} style={{ padding:'6px 12px', background:C.inputBg, border:`1px solid ${C.border}`, borderRadius:8, color:C.text, fontSize:18, cursor:'pointer' }}>ÃÂ¢ÃÂÃÂ¹</button>
                  <div style={{ fontSize:15, fontWeight:700, color:C.text }}>{CAL_MONTHS[calMonth]} {calYear}</div>
                  <button onClick={() => { let m=calMonth+1,y=calYear; if(m>11){m=0;y++;} setCalMonth(m);setCalYear(y);setSelectedDay(null); }} style={{ padding:'6px 12px', background:C.inputBg, border:`1px solid ${C.border}`, borderRadius:8, color:C.text, fontSize:18, cursor:'pointer' }}>ÃÂ¢ÃÂÃÂº</button>
                </div>
                {/* Grille calendrier */}
                ...
                <button onClick={() => openNewEvent(selectedDay||today)} style={{ width:'100%', padding:12, background:C.accent, border:'none', borderRadius:10, color:'white', fontWeight:700, fontSize:14, cursor:'pointer', marginBottom:12, fontFamily:'inherit' }}>
                  + Ajouter un rendez-vous{selectedDay ? ` ÃÂ¢ÃÂÃÂ ${selectedDay}` : ''}
                </button>
                {/* Sync status */}
                <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:10 }}>
                  <div style={{ fontSize:11, color:C.textMuted }}>
                    {scheduleSync==='sync'&&'ÃÂ¢ÃÂÃÂ³ SyncÃÂ¢ÃÂÃÂ¦'}{scheduleSync==='ok'&&<span style={{color:'#16a34a'}}>ÃÂ¢ÃÂÃÂ SynchronisÃÂÃÂ©</span>}{scheduleSync==='offline'&&<span style={{color:'#c0392b'}}>ÃÂ°ÃÂÃÂÃÂµ Hors-ligne</span>}
                  </div>
                  <button onClick={syncSchedule} style={{ padding:'4px 8px', background:C.card, border:`1px solid ${C.border}`, borderRadius:6, color:C.textMuted, cursor:'pointer', fontSize:11, fontFamily:'inherit' }}>ÃÂ°ÃÂÃÂÃÂ</button>
                </div>
                {/* ÃÂÃÂvÃÂÃÂ©nements du jour sÃÂÃÂ©lectionnÃÂÃÂ© ou prochains */}
                {selectedDay ? (
                  dayEvs.length === 0 ? (
                    ...
                    <div key={ev.id} style={{ background:C.card, border:`1px solid ${C.border}`, borderRadius:10, padding:12, marginBottom:10 }}>
                      <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start' }}>
                        <div style={{ flex:1 }}>
                          ...
                          {ev.clientName && <div style={{ fontSize:12, color:C.textMuted }}>ÃÂ°ÃÂÃÂÃÂ¤ {ev.clientName}</div>}
                          {ev.clientPhone && <div style={{ fontSize:12, color:C.textMuted }}>ÃÂ°ÃÂÃÂÃÂ {ev.clientPhone}</div>}
                          {ev.address && <div style={{ fontSize:12, color:C.textMuted }}>ÃÂ°ÃÂÃÂÃÂ {ev.address}</div>}
                          <div style={{ fontSize:12, color:C.textMuted }}>ÃÂ°ÃÂÃÂÃÂ {ev.time}{ev.duration ? ` (${ev.duration}h)` : ''}</div>
                      ...
                      <div style={{ display:'flex', gap:6, marginTop:10, flexWrap:'wrap' }}>
                        <button onClick={() => openEditEvent(ev)} style={{ flex:1, padding:'8px 0', background:C.inputBg, border:`1px solid ${C.border}`, borderRadius:8, color:C.text, fontSize:12, cursor:'pointer', fontFamily:'inherit' }}>ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ Modifier</button>
                        {ev.needsSignature && !ev.signature && <button onClick={() => setSigState({ eventId:ev.id })} style={{ flex:1, padding:'8px 0', background:'#d97706', border:'none', borderRadius:8, color:'white', fontSize:12, fontWeight:700, cursor:'pointer', fontFamily:'inherit' }}>ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ Signature</button>}
                        {ev.signature && <button onClick={() => setSigState({ eventId:ev.id, viewOnly:true, sigData:ev.signature })} style={{ flex:1, padding:'8px 0', background:'#16a34a', border:'none', borderRadius:8, color:'white', fontSize:12, cursor:'pointer', fontFamily:'inherit' }}>ÃÂ¢ÃÂÃÂ SignÃÂÃÂ©</button>}
                        {ev.clientEmail && (
                          <button
                          ...
                          >{reminderSending[ev.id+'_reminder']==='sending'?'ÃÂ¢ÃÂÃÂ³':reminderSending[ev.id+'_reminder']==='ok'?'ÃÂ¢ÃÂÃÂ EnvoyÃÂÃÂ©':reminderSending[ev.id+'_reminder']==='err'?'ÃÂ¢ÃÂÃÂ Erreur':'ÃÂ°ÃÂÃÂÃÂ§ Rappel'}</button>
                        )}
                        {ev.clientEmail && (
                          <button
                          ...
                          >{reminderSending[ev.id+'_confirmation']==='sending'?'ÃÂ¢ÃÂÃÂ³':reminderSending[ev.id+'_confirmation']==='ok'?'ÃÂ¢ÃÂÃÂ EnvoyÃÂÃÂ©':reminderSending[ev.id+'_confirmation']==='err'?'ÃÂ¢ÃÂÃÂ Erreur':'ÃÂ¢ÃÂÃÂ Confirmer'}</button>
                        )}
                        <button onClick={() => { if(window.confirm('Supprimer ce rendez-vous?')) deleteScheduleEvent(ev.id); }} style={{ padding:'8px 12px', background:'transparent', border:`1px solid #c0392b`, borderRadius:8, color:'#c0392b', fontSize:12, cursor:'pointer', fontFamily:'inherit' }}>ÃÂ°ÃÂÃÂÃÂÃÂ¯ÃÂ¸ÃÂ</button>
                  ...
                  <div>
                    ...
                    {upcoming.length===0 ? <div style={{ textAlign:'center', color:C.textMuted, fontSize:14, padding:'20px 0' }}>Aucun rendez-vous ÃÂÃÂ  venir</div> : upcoming.map(ev => (
                      <div key={ev.id} onClick={() => { setCalYear(parseInt(ev.date.slice(0,4))); setCalMonth(parseInt(ev.date.slice(5,7))-1); setSelectedDay(ev.date); }} style={{ background:C.card, border:`1px solid ${C.border}`, borderRadius:10, padding:'10px 12px', marginBottom:8, cursor:'pointer', borderLeft:`4px solid ${EV_COLORS[ev.status]||C.accent}` }}>
                        ...
                        <div style={{ fontSize:12, color:C.textMuted }}>{ev.date} ÃÂÃÂ  {ev.time}{ev.clientName ? ` ÃÂ¢ÃÂÃÂ ${ev.clientName}` : ''}</div>
                      </div>
                    ))}
                  </div>
                )}
            ...
            <div>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
                <div style={{ fontSize: 13, fontWeight: 700, color: C.text }}>
                  ÃÂ°ÃÂÃÂÃÂ Listes sauvegardÃÂÃÂ©es ({listHistory.length})
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  {historySync === 'sync' && <div style={{ fontSize: 11, color: C.textMuted }}>ÃÂ¢ÃÂÃÂ³ SyncÃÂ¢ÃÂÃÂ¦</div>}
                  {historySync === 'ok' && <div style={{ fontSize: 11, color: '#16a34a' }}>ÃÂ¢ÃÂÃÂ SynchronisÃÂÃÂ©</div>}
                  {historySync === 'offline' && <div style={{ fontSize: 11, color: '#c0392b' }}>ÃÂ°ÃÂÃÂÃÂµ Hors-ligne</div>}
                  <button onClick={() => syncHistory()} disabled={historySync === 'sync'} style={{ padding: '5px 10px', background: C.card, border: `1px solid ${C.border}`, borderRadius: 6, color: C.textMuted, cursor: 'pointer', fontFamily: 'inherit', fontSize: 11, touchAction: 'manipulation', opacity: historySync === 'sync' ? 0.5 : 1 }}>ÃÂ°ÃÂÃÂÃÂ</button>
                </div>
              </div>
              {listHistory.length === 0 ? (
                <div style={{ textAlign: 'center', padding: '40px 20px', color: C.textLight, fontSize: 14 }}>
                  Aucune liste sauvegardÃÂÃÂ©e pour l'instant.<br/>Analysez une liste pour commencer.
                </div>
              ) : (
                <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                  {listHistory.map(entry => {
                    ...
                    return (
                      <div key={entry.id} style={{ background: C.card, border: `1px solid ${isEditing ? C.accent : C.border}`, borderRadius: 12, padding: 14 }}>
                        {isEditing ? (
                          <div>
                            <div style={{ fontSize: 12, fontWeight: 700, color: C.accent, marginBottom: 10 }}>ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ Modifier les infos client</div>
                          ...
                          <>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 8 }}>
                              <div>
                                ...
                                <div style={{ fontSize: 11, color: C.textLight, marginTop: 2 }}>{dateStr} ÃÂÃÂ  {timeStr} ÃÂÃÂ· {entry.items.length} items</div>
                              </div>
                              <div style={{ textAlign: 'right' }}>
                            ...
                            <div style={{ fontSize: 11, color: C.textMuted, marginBottom: 10, lineHeight: 1.6 }}>
                              {entry.items.slice(0, 3).map(i => `${i.qty}ÃÂÃÂ ${i.product.name}`).join(' ÃÂÃÂ· ')}
                              {entry.items.length > 3 && ` ÃÂÃÂ· +${entry.items.length - 3} autres`}
                            </div>
                            <div style={{ display: 'flex', gap: 8 }}>
          ...
          {tab === 'margins' && (() => {
            ...
            return (
              <div>
                <div style={{ fontSize: 13, fontWeight: 700, color: C.text, marginBottom: 16 }}>Marges par catÃÂÃÂ©gorie</div>
                {cats.map(cat => {
  ...
  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ DESKTOP LAYOUT ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  return (
    <div style={{ minHeight: "100vh", background: C.bg, fontFamily: "system-ui, -apple-system, sans-serif", color: C.text }}>
      ...
      <div style={{ background: C.header, padding: "0 24px", boxShadow: "0 2px 8px rgba(0,0,0,0.15)" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64 }}>
          <img src={process.env.PUBLIC_URL + '/logo.svg'} alt="RÃÂÃÂ©volution Plomberie" style={{ height: 44, filter: 'brightness(0) invert(1)', display: 'block' }} />
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            {[["parse", "ÃÂ°ÃÂÃÂÃÂ Notes"], ["invoice", `ÃÂ°ÃÂÃÂÃÂ¦ Liste matÃÂÃÂ©riel (${invoiceItems.length})`], ["schedule", `ÃÂ°ÃÂÃÂÃÂ Horaire (${listSchedule.length})`], ["catalog", "ÃÂ°ÃÂÃÂÃÂÃÂ¯ÃÂ¸ÃÂ Catalogue"], ["history", `ÃÂ°ÃÂÃÂÃÂ Historique (${listHistory.length})`], ["margins", "ÃÂ°ÃÂÃÂÃÂ Marges"]].map(([id, label]) => (
            ...
            <div className="no-print" style={{ display: "flex", alignItems: "center", gap: 6, marginLeft: 8 }}>
              {isMobile && (
                <button onClick={() => setMobileView('mobile')} style={{ padding: "8px 12px", background: "rgba(255,255,255,0.1)", border: "1px solid rgba(255,255,255,0.2)", borderRadius: 6, color: "white", cursor: "pointer", fontSize: 13, fontFamily: "inherit" }}>ÃÂ°ÃÂÃÂÃÂ±</button>
              )}
              <button onClick={() => { localStorage.removeItem('plomb_auth'); setAuthed(false); }} style={{ padding: "8px 12px", background: "rgba(255,255,255,0.1)", border: "1px solid rgba(255,255,255,0.2)", borderRadius: 6, color: "white", cursor: "pointer", fontSize: 13, fontFamily: "inherit" }}>ÃÂ°ÃÂÃÂÃÂ</button>
              <div style={{ position: "relative" }}>
                <button onClick={() => setShowThemes(p => !p)} style={{ padding: "8px 12px", background: "rgba(255,255,255,0.1)", border: "1px solid rgba(255,255,255,0.2)", borderRadius: 6, color: "white", cursor: "pointer", fontSize: 16, fontFamily: "inherit" }}>ÃÂ°ÃÂÃÂÃÂ¨</button>
                {showThemes && (
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
              <div>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
                  ...
                  {notesText.trim() && (
                    <button onClick={() => setNotesText('')} style={{ padding: "4px 12px", background: "transparent", border: `1px solid ${C.border}`, borderRadius: 6, color: C.textMuted, cursor: "pointer", fontFamily: "inherit", fontSize: 12 }}>ÃÂ°ÃÂÃÂÃÂÃÂ¯ÃÂ¸ÃÂ Effacer</button>
                  )}
                </div>
                <textarea
                  value={notesText}
                  onChange={e => setNotesText(e.target.value)}
                  placeholder="Collez votre liste de matÃÂÃÂ©riaux ici..."
                  style={{
              ...
              <div>
                ...
                <div style={{ background: C.card, borderRadius: 10, padding: 20, border: `1px solid ${C.border}`, boxShadow: "0 1px 4px rgba(0,0,0,0.06)" }}>
                  <div style={{ fontSize: 13, lineHeight: 2, color: C.textMuted }}>
                    <div style={{ color: C.accent, marginBottom: 8, fontWeight: 600 }}>Comment ÃÂÃÂ§a fonctionne:</div>
                    <div>1. Copiez votre liste depuis Apple Notes</div>
                    <div>2. Collez le texte dans la zone ÃÂÃÂ  gauche</div>
                    <div>3. Cliquez "Analyser avec l'IA"</div>
                    <div>4. Confirmez les items incertains si demandÃÂÃÂ©</div>
                    <div>5. VÃÂÃÂ©rifiez et modifiez la facture gÃÂÃÂ©nÃÂÃÂ©rÃÂÃÂ©e</div>
                    <div style={{ color: C.accent, marginTop: 12, marginBottom: 8, fontWeight: 600 }}>Formats acceptÃÂÃÂ©s:</div>
                    <div style={{ fontFamily: "monospace", background: C.inputBg, padding: 12, borderRadius: 6, fontSize: 12, color: C.text, border: `1px solid ${C.border}` }}>
                      <div>ÃÂ¢ÃÂÃÂ¢ "6x coude 90 1.5"</div>
                      <div>ÃÂ¢ÃÂÃÂ¢ "2.5 longueurs 3/4 uponor"</div>
                      <div>ÃÂ¢ÃÂÃÂ¢ "1003 x 3" (code direct)</div>
                      <div>ÃÂ¢ÃÂÃÂ¢ "valve antibelier uponor"</div>
                    </div>
                    <div style={{ color: C.textLight, marginTop: 12, fontSize: 11 }}>
                      {Object.keys({...PRODUCTS,...customProducts}).length} produits ÃÂÃÂ· TPS 5% ÃÂÃÂ· TVQ 9.975%
                    </div>
                  </div>
                </div>
              </div>
            ...
            {pendingReview.length > 0 && (
              <div style={{ marginTop: 24 }}>
                <div style={{ fontSize: 14, fontWeight: 700, color: "#e67e22", marginBottom: 12, display: "flex", alignItems: "center", gap: 8 }}>
                  ...
                  Item{pendingReview.length > 1 ? "s" : ""} ÃÂÃÂ  confirmer ÃÂ¢ÃÂÃÂ L'IA n'est pas certaine, choisissez le bon produit:
                </div>
                    ...
                    <div key={r.id} style={{ background: C.card, border: `2px solid #e67e22`, borderRadius: 10, padding: 16, boxShadow: "0 2px 8px rgba(0,0,0,0.08)" }}>
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 12 }}>
                        <div>
                          ...
                          <div style={{ fontSize: 12, color: C.textMuted, marginTop: 2 }}>QuantitÃÂÃÂ©: <strong>{r.qty}</strong> ÃÂÃÂ· Confiance IA: <strong style={{ color: r.confidence >= 0.6 ? "#e67e22" : "#c0392b" }}>{Math.round(r.confidence * 100)}%</strong></div>
                        </div>
                      ...
                      <div style={{ display: "grid", gridTemplateColumns: `repeat(${Math.min(r.matches.length, 3)}, 1fr)`, gap: 8 }}>
                        {r.matches.slice(0, 3).map((m, idx) => (
                          <button key={m.code} onClick={() => confirmReviewItem(r.id, m.code)} style={{
                            ...
                            <div style={{ fontSize: 11, color: C.textMuted, marginBottom: 4 }}>#{m.code} ÃÂÃÂ· {m.product.dim}</div>
                ...
                {invoiceItems.length > 0 && (
                  <button onClick={() => { setPendingReview([]); setTab("invoice"); }} style={{ marginTop: 16, padding: "10px 20px", background: C.accent, border: "none", borderRadius: 6, color: "white", cursor: "pointer", fontFamily: "inherit", fontSize: 13, fontWeight: 700 }}>
                    Voir la facture ({invoiceItems.length} items confirmÃÂÃÂ©s) ÃÂ¢ÃÂÃÂ
                  </button>
                )}
              </div>
            )}
          ...
          <div>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 16, marginBottom: 24 }}>
              {[
                ...
                ["Client / SociÃÂÃÂ©tÃÂÃÂ©", clientName, setClientName],
                ...
                <table style={{ width: "100%", borderCollapse: "collapse" }}>
                  <thead>
                    <tr style={{ background: "#e8f2fb" }}>
                      {["Code", "Dim", "Description", "CatÃÂÃÂ©gorie", "QtÃÂÃÂ©", "Prix unit.", "Total", ""].map(h => (
                  ...
                  <tbody>
                    {invoiceItems.length === 0 && (
                      <tr><td colSpan={8} style={{ padding: 40, textAlign: "center", color: C.textLight, fontSize: 13 }}>
                        Aucun article ÃÂ¢ÃÂÃÂ parsez vos notes ou ajoutez depuis le catalogue
                      </td></tr>
                    )}
                    {invoiceItems.map((item, idx) => (
                      <tr key={item.id} style={{ borderBottom: `1px solid ${C.rowBorder}`, background: idx % 2 === 0 ? C.card : C.rowAlt }}>
                        ...
                        <td style={{ padding: "10px 16px" }}>
                          <button onClick={() => removeItem(item.id)} style={{ background: "none", border: "none", color: C.textLight, cursor: "pointer", fontSize: 16, padding: 0 }}>ÃÂ¢ÃÂÃÂ</button>
                        </td>
                      </tr>
                    ))}
                  </tbody>
            ...
            <div style={{ display: "flex", gap: 12, marginTop: 20, alignItems: "center", flexWrap: "wrap" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8, background: C.card, border: `1px solid ${C.border}`, borderRadius: 8, padding: "8px 12px" }}>
                <span style={{ fontSize: 12, fontWeight: 700, color: C.textMuted, whiteSpace: "nowrap" }}>ÃÂ°ÃÂÃÂÃÂ Marge :</span>
                {[0, 5, 10, 15, 20].map(pct => (
                  <button key={pct} onClick={() => setMargeBonus(pct / 100)}
              ...
              {saveStatus && <div style={{ fontSize: 13, fontWeight: 600, color: saveStatus.startsWith('ÃÂ¢ÃÂÃÂ') ? "#16a34a" : "#c0392b" }}>{saveStatus}</div>}
            </div>
          </div>
        )}
          ...
          return (
            <div style={{ display:'grid', gridTemplateColumns:'1fr 360px', gap:24 }}>
              ...
              <div>
                {/* Header mois */}
                <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:16 }}>
                  <button onClick={() => { let m=calMonth-1,y=calYear; if(m<0){m=11;y--;} setCalMonth(m);setCalYear(y);setSelectedDay(null); }} style={{ padding:'8px 16px', background:C.inputBg, border:`1px solid ${C.border}`, borderRadius:8, color:C.text, fontSize:20, cursor:'pointer' }}>ÃÂ¢ÃÂÃÂ¹</button>
                  <div style={{ fontSize:20, fontWeight:700, color:C.text }}>{CAL_MONTHS[calMonth]} {calYear}</div>
                  <button onClick={() => { let m=calMonth+1,y=calYear; if(m>11){m=0;y++;} setCalMonth(m);setCalYear(y);setSelectedDay(null); }} style={{ padding:'8px 16px', background:C.inputBg, border:`1px solid ${C.border}`, borderRadius:8, color:C.text, fontSize:20, cursor:'pointer' }}>ÃÂ¢ÃÂÃÂº</button>
                </div>
                {/* Grille */}
              ...
              {/* Colonne droite : dÃÂÃÂ©tails + formulaire */}
              <div>
                <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:12 }}>
                  <div style={{ fontSize:14, fontWeight:700, color:C.text }}>{selectedDay ? selectedDay : 'SÃÂÃÂ©lectionnez un jour'}</div>
                  <div style={{ display:'flex', gap:6, alignItems:'center' }}>
                    {scheduleSync==='sync'&&<span style={{fontSize:11,color:C.textMuted}}>ÃÂ¢ÃÂÃÂ³</span>}
                    {scheduleSync==='ok'&&<span style={{fontSize:11,color:'#16a34a'}}>ÃÂ¢ÃÂÃÂ</span>}
                    {scheduleSync==='offline'&&<span style={{fontSize:11,color:'#c0392b'}}>ÃÂ°ÃÂÃÂÃÂµ</span>}
                    <button onClick={syncSchedule} style={{ padding:'4px 8px', background:C.card, border:`1px solid ${C.border}`, borderRadius:6, color:C.textMuted, cursor:'pointer', fontSize:11 }}>ÃÂ°ÃÂÃÂÃÂ</button>
                  </div>
                </div>
                <button onClick={() => openNewEvent(selectedDay||today)} style={{ width:'100%', padding:'10px 0', background:C.accent, border:'none', borderRadius:8, color:'white', fontWeight:700, fontSize:13, cursor:'pointer', marginBottom:14, fontFamily:'inherit' }}>
                  + Nouveau rendez-vous{selectedDay ? ` ÃÂ¢ÃÂÃÂ ${selectedDay}` : ''}
                </button>
                {selectedDay ? (
                  dayEvs.length===0 ? (
                    ...
                    <div key={ev.id} style={{ background:C.card, border:`1px solid ${C.border}`, borderRadius:10, padding:14, marginBottom:10, borderLeft:`4px solid ${EV_COLORS[ev.status]||C.accent}` }}>
                      ...
                      {ev.clientName && <div style={{ fontSize:12, color:C.textMuted }}>ÃÂ°ÃÂÃÂÃÂ¤ {ev.clientName}</div>}
                      {ev.clientPhone && <div style={{ fontSize:12, color:C.textMuted }}>ÃÂ°ÃÂÃÂÃÂ {ev.clientPhone}</div>}
                      {ev.clientEmail && <div style={{ fontSize:12, color:C.textMuted }}>ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ {ev.clientEmail}</div>}
                      {ev.address && <div style={{ fontSize:12, color:C.textMuted }}>ÃÂ°ÃÂÃÂÃÂ {ev.address}</div>}
                      <div style={{ fontSize:12, color:C.textMuted }}>ÃÂ°ÃÂÃÂÃÂ {ev.time}{ev.duration ? ` (${ev.duration}h)` : ''}</div>
                      {ev.notes && <div style={{ fontSize:12, color:C.textMuted, marginTop:4, fontStyle:'italic' }}>{ev.notes}</div>}
                      {ev.signature && <div style={{ fontSize:11, color:'#16a34a', marginTop:4 }}>ÃÂ¢ÃÂÃÂ Entente signÃÂÃÂ©e le {ev.signedAt ? new Date(ev.signedAt).toLocaleDateString('fr-CA') : ''}</div>}
                      <div style={{ display:'flex', gap:6, marginTop:10, flexWrap:'wrap' }}>
                        <button onClick={() => openEditEvent(ev)} style={{ flex:1, padding:'7px 0', background:C.inputBg, border:`1px solid ${C.border}`, borderRadius:6, color:C.text, fontSize:12, cursor:'pointer', fontFamily:'inherit' }}>ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ Modifier</button>
                        {ev.needsSignature && !ev.signature && <button onClick={() => setSigState({ eventId:ev.id })} style={{ flex:1, padding:'7px 0', background:'#d97706', border:'none', borderRadius:6, color:'white', fontSize:12, fontWeight:700, cursor:'pointer', fontFamily:'inherit' }}>ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ Signature</button>}
                        {ev.signature && <button onClick={() => setSigState({ eventId:ev.id, viewOnly:true, sigData:ev.signature })} style={{ flex:1, padding:'7px 0', background:'#16a34a', border:'none', borderRadius:6, color:'white', fontSize:12, cursor:'pointer', fontFamily:'inherit' }}>ÃÂ¢ÃÂÃÂ SignÃÂÃÂ©</button>}
                        {ev.clientEmail && (
                          <button
                            onClick={() => sendEventReminder(ev, 'reminder')}
                            disabled={reminderSending[ev.id+'_reminder']==='sending'}
                          ...
                          >{reminderSending[ev.id+'_reminder']==='sending'?'ÃÂ¢ÃÂÃÂ³':reminderSending[ev.id+'_reminder']==='ok'?'ÃÂ¢ÃÂÃÂ':reminderSending[ev.id+'_reminder']==='err'?'ÃÂ¢ÃÂÃÂ':'ÃÂ°ÃÂÃÂÃÂ§ Rappel'}</button>
                        )}
                        {ev.clientEmail && (
                          <button
                            onClick={() => sendEventReminder(ev, 'confirmation')}
                          ...
                          >{reminderSending[ev.id+'_confirmation']==='sending'?'ÃÂ¢ÃÂÃÂ³':reminderSending[ev.id+'_confirmation']==='ok'?'ÃÂ¢ÃÂÃÂ':reminderSending[ev.id+'_confirmation']==='err'?'ÃÂ¢ÃÂÃÂ':'ÃÂ¢ÃÂÃÂ Confirmer'}</button>
                        )}
                        <button onClick={() => { if(window.confirm('Supprimer?')) deleteScheduleEvent(ev.id); }} style={{ padding:'7px 10px', background:'transparent', border:`1px solid #c0392b`, borderRadius:6, color:'#c0392b', fontSize:12, cursor:'pointer', fontFamily:'inherit' }}>ÃÂ°ÃÂÃÂÃÂÃÂ¯ÃÂ¸ÃÂ</button>
                      </div>
                    </div>
                  ))
                ) : (
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                {historySync === 'sync' && <div style={{ fontSize: 12, color: C.textMuted }}>ÃÂ¢ÃÂÃÂ³ SynchronisationÃÂ¢ÃÂÃÂ¦</div>}
                {historySync === 'ok' && <div style={{ fontSize: 12, color: '#16a34a' }}>ÃÂ¢ÃÂÃÂ SynchronisÃÂÃÂ© avec tous les appareils</div>}
                {historySync === 'offline' && <div style={{ fontSize: 12, color: '#c0392b' }}>ÃÂ°ÃÂÃÂÃÂµ Hors-ligne ÃÂ¢ÃÂÃÂ local seulement</div>}
                <button onClick={() => syncHistory()} disabled={historySync === 'sync'} style={{ padding: '6px 12px', background: C.card, border: `1px solid ${C.border}`, borderRadius: 6, color: C.textMuted, cursor: 'pointer', fontFamily: 'inherit', fontSize: 12, opacity: historySync === 'sync' ? 0.5 : 1 }}>ÃÂ°ÃÂÃÂÃÂ RafraÃÂÃÂ®chir</button>
              </div>
            </div>
            {listHistory.length === 0 ? (
              <div style={{ textAlign: 'center', padding: '60px 20px', color: C.textLight, fontSize: 14 }}>
                Aucune liste sauvegardÃÂÃÂ©e pour l'instant. Analysez une liste pour commencer.
              </div>
            ) : (
                ...
                {listHistory.map(entry => {
                  ...
                  return (
                    <div key={entry.id} style={{ background: C.card, border: `1px solid ${isEditing ? C.accent : C.border}`, borderRadius: 10, padding: 18, boxShadow: "0 1px 4px rgba(0,0,0,0.06)" }}>
                      {isEditing ? (
                        <div>
                          <div style={{ fontSize: 13, fontWeight: 700, color: C.accent, marginBottom: 12 }}>ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ Modifier les infos client</div>
                          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 120px', gap: 10, marginBottom: 12 }}>
                            {[['Client / SociÃÂÃÂ©tÃÂÃÂ©', 'clientName'], ['Description du travail', 'jobDesc'], ['Facture #', 'invoiceNum']].map(([label, key]) => (
                              <div key={key}>
                        ...
                        <>
                          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 10 }}>
                            <div>
                              ...
                              <div style={{ fontSize: 11, color: C.textLight, marginTop: 4 }}>{dateStr} ÃÂÃÂ  {timeStr} ÃÂÃÂ· {entry.items.length} articles</div>
                            </div>
                          ...
                          <div style={{ fontSize: 11, color: C.textMuted, marginBottom: 12, lineHeight: 1.7, borderTop: `1px solid ${C.border}`, paddingTop: 10 }}>
                            {entry.items.slice(0, 4).map(i => `${i.qty}ÃÂÃÂ ${i.product.name}`).join(' ÃÂÃÂ· ')}
                            {entry.items.length > 4 && ` ÃÂÃÂ· +${entry.items.length - 4} autres`}
                          </div>
                          <div style={{ display: 'flex', gap: 8 }}>
                            <button onClick={() => loadFromHistory(entry)} style={{ flex: 1, padding: "8px 14px", background: C.accent, border: "none", borderRadius: 6, color: "white", cursor: "pointer", fontFamily: "inherit", fontSize: 13, fontWeight: 700 }}>
                              ÃÂ¢ÃÂÃÂ© Charger cette liste
                            </button>
                            <button onClick={() => { setEditingHistoryId(entry.id); setEditHistoryForm({ clientName: entry.clientName || '', jobDesc: entry.jobDesc || '', invoiceNum: entry.invoiceNum || '' }); }} style={{ padding: "8px 12px", background: C.card, border: `1px solid ${C.border}`, borderRadius: 6, color: C.textMuted, cursor: "pointer", fontFamily: "inherit", fontSize: 13 }}>
                              ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ Modifier
                            </button>
          ...
          <div>
            ...
            {showAddForm && (
              <div style={{ background: C.card, border: `2px solid ${C.accent}`, borderRadius: 10, padding: 20, marginBottom: 20, boxShadow: "0 2px 12px rgba(0,0,0,0.1)" }}>
                <div style={{ fontSize: 14, fontWeight: 700, color: C.accent, marginBottom: 16 }}>ÃÂ¢ÃÂÃÂ Ajouter un nouveau produit</div>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 2fr 1fr 1fr 1fr", gap: 12, marginBottom: 12 }}>
                  {[
                    ["Code", "code", "ex: 5001"],
                    ["Nom", "name", "ex: Coude 90 spÃÂÃÂ©cial"],
                  ...
                  <div>
                    <div style={{ fontSize: 11, fontWeight: 600, color: C.textMuted, marginBottom: 5, textTransform: "uppercase", letterSpacing: 0.5 }}>CatÃÂÃÂ©gorie</div>
                    <select
                  ...
                  <div>
                    <div style={{ fontSize: 11, fontWeight: 600, color: C.textMuted, marginBottom: 5, textTransform: "uppercase", letterSpacing: 0.5 }}>CoÃÂÃÂ»t ($)</div>
                    <input
                      type="number"
                ...
                {newProduct.cost && parseFloat(newProduct.cost) > 0 && (
                  <div style={{ fontSize: 12, color: C.textMuted, marginBottom: 10 }}>
                    Prix de vente calculÃÂÃÂ©: <strong style={{ color: C.accent }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 }}>
              <div style={{ fontSize: 12, color: C.textLight }}>{filtered.length} produits{Object.keys(customProducts).length > 0 && ` (dont ${Object.keys(customProducts).length} personnalisÃÂÃÂ©s)`}</div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                {catalogSync === 'sync' && <div style={{ fontSize: 12, color: C.textMuted }}>ÃÂ¢ÃÂÃÂ³ Sync catalogueÃÂ¢ÃÂÃÂ¦</div>}
                {catalogSync === 'ok' && <div style={{ fontSize: 12, color: '#16a34a' }}>ÃÂ¢ÃÂÃÂ Catalogue synchronisÃÂÃÂ©</div>}
                {catalogSync === 'offline' && <div style={{ fontSize: 12, color: '#c0392b' }}>ÃÂ°ÃÂÃÂÃÂµ Hors-ligne</div>}
                <button onClick={() => syncCatalog()} disabled={catalogSync === 'sync'} style={{ padding: '6px 12px', background: C.card, border: `1px solid ${C.border}`, borderRadius: 6, color: C.textMuted, cursor: 'pointer', fontFamily: 'inherit', fontSize: 12, opacity: catalogSync === 'sync' ? 0.5 : 1 }}>ÃÂ°ÃÂÃÂÃÂ RafraÃÂÃÂ®chir</button>
              </div>
            </div>
              ...
              {filtered.map(p => {
                ...
                if (isEditing) return (
                  <div key={p.code} style={{ background: C.card, border: `2px solid ${C.accent}`, borderRadius: 8, padding: "14px", boxShadow: "0 2px 8px rgba(0,0,0,0.1)" }}>
                    <div style={{ fontSize: 11, fontWeight: 700, color: C.accent, marginBottom: 10 }}>ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ MODIFIER #{p.code}</div>
                    <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                      {[["Nom", "name", "text"], ["Dimension", "dim", "text"], ["CoÃÂÃÂ»t ($)", "cost", "number"]].map(([label, field, type]) => (
                        <div key={field}>
                      ...
                      <div>
                        <div style={{ fontSize: 10, color: C.textMuted, marginBottom: 3, fontWeight: 600 }}>CatÃÂÃÂ©gorie</div>
                        <select value={editForm.category} onChange={e => setEditForm(f => ({ ...f, category: e.target.value }))}
                      ...
                      <div>
                        <div style={{ fontSize: 10, color: C.textMuted, marginBottom: 3, fontWeight: 600 }}>
                          Marge individuelle (%) ÃÂ¢ÃÂÃÂ <span style={{ fontWeight: 400 }}>laisser vide pour utiliser la marge de la catÃÂÃÂ©gorie ({Math.round((categoryMargins[editForm.category] ?? DEFAULT_MARGINS[editForm.category]) * 100)}%)</span>
                        </div>
                        <input type="number" min="1" max="60" placeholder={`${Math.round((categoryMargins[editForm.category] ?? DEFAULT_MARGINS[editForm.category]) * 100)} (catÃÂÃÂ©gorie)`}
                          value={editForm.overrideMargin ?? ''}
                          onChange={e => setEditForm(f => ({ ...f, overrideMargin: e.target.value === '' ? null : e.target.value }))}
                      ...
                      <div style={{ display: "flex", gap: 8, marginTop: 4 }}>
                        <button onClick={() => saveEdit(String(p.code))} style={{ flex: 1, padding: "7px", background: C.accent, border: "none", borderRadius: 5, color: "white", cursor: "pointer", fontFamily: "inherit", fontSize: 12, fontWeight: 700 }}>ÃÂ¢ÃÂÃÂ Sauver</button>
                ...
                return (
                  <div key={p.code} style={{
                    ...
                    <div style={{ textAlign: "right" }}>
                      ...
                      <div style={{ fontSize: 10, color: C.textLight, marginBottom: 6 }}>coÃÂÃÂ»t: {fmt(p.cost)}</div>
                      <div style={{ display: "flex", gap: 6 }}>
                        <button onClick={() => startEdit(p)} style={{ padding: "4px 8px", background: C.inputBg, border: `1px solid ${C.border}`, borderRadius: 5, color: C.textMuted, cursor: "pointer", fontFamily: "inherit", fontSize: 11 }}>ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ</button>
                        {isCustom && (
                          <button onClick={() => deleteCustomProduct(String(p.code))} style={{ padding: "4px 8px", background: "#fdecea", border: "1px solid #f5c6c6", borderRadius: 5, color: "#c0392b", cursor: "pointer", fontFamily: "inherit", fontSize: 11 }}>ÃÂ¢ÃÂÃÂ</button>
                        )}
          ...
          return (
            <div style={{ maxWidth: 700 }}>
              ...
              <div style={{ background: C.card, borderRadius: 10, border: `1px solid ${C.border}`, padding: 24, marginBottom: 20, boxShadow: "0 2px 8px rgba(0,0,0,0.07)" }}>
                <div style={{ fontSize: 14, fontWeight: 700, color: C.text, marginBottom: 4 }}>Marges par catÃÂÃÂ©gorie</div>
                <div style={{ fontSize: 12, color: C.textMuted, marginBottom: 20 }}>Ces marges s'appliquent ÃÂÃÂ  tous les produits de la catÃÂÃÂ©gorie, sauf si une marge individuelle est dÃÂÃÂ©finie.</div>
                ...
                <div style={{ marginTop: 16, padding: "10px 14px", background: C.inputBg, borderRadius: 6, border: `1px solid ${C.border}`, fontSize: 12, color: C.textMuted }}>
                  ÃÂ¢ÃÂÃÂ¹ÃÂ¯ÃÂ¸ÃÂ La marge est calculÃÂÃÂ©e sur le prix de vente: <code style={{ background: C.card, padding: "1px 5px", borderRadius: 3 }}>prix vente = coÃÂÃÂ»t ÃÂÃÂ· (1 ÃÂ¢ÃÂÃÂ marge)</code>. Une marge de 30% sur un item de 10$ donne 14.29$.
                </div>
              </div>
              ...
              <div style={{ background: C.card, borderRadius: 10, border: `1px solid ${C.border}`, padding: 24, boxShadow: "0 2px 8px rgba(0,0,0,0.07)" }}>
                ...
                <div style={{ fontSize: 12, color: C.textMuted, marginBottom: 16 }}>
                  Pour modifier la marge d'un produit spÃÂÃÂ©cifique, cliquez ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ sur le produit dans le <button onClick={() => setTab("catalog")} style={{ background: "none", border: "none", color: C.accent, cursor: "pointer", fontFamily: "inherit", fontSize: 12, padding: 0, fontWeight: 600 }}>Catalogue</button> et ajustez le % de marge.
                </div>
                {(() => {
                  const withOverride = Object.values(customProducts).filter(p => p.overrideMargin != null);
                  if (withOverride.length === 0) return <div style={{ color: C.textLight, fontSize: 13 }}>Aucune marge individuelle dÃÂÃÂ©finie pour l'instant.</div>;
                  return (
                    <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                      {withOverride.map(p => (
                        <div key={p.code} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "8px 12px", background: C.inputBg, borderRadius: 6, border: `1px solid ${C.border}` }}>
                          <div>
                            ...
                            <span style={{ fontSize: 11, color: C.textMuted, marginLeft: 8 }}>#{p.code} ÃÂÃÂ· {p.category}</span>
                          </div>
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ MODAL FORMULAIRE ÃÂÃÂVÃÂÃÂNEMENT ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
    ...
    <div style={{ position:'fixed', inset:0, background:'rgba(0,0,0,0.7)', zIndex:200, display:'flex', alignItems:'center', justifyContent:'center', padding:16 }}>
      <div style={{ background:C.card, border:`1px solid ${C.border}`, borderRadius:16, padding:24, width:'100%', maxWidth:520, maxHeight:'90vh', overflowY:'auto' }}>
        <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:20 }}>
          <div style={{ fontSize:16, fontWeight:700, color:C.text }}>{editingEvId ? 'ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ Modifier le rendez-vous' : '+ Nouveau rendez-vous'}</div>
          <button onClick={onClose} style={{ background:'transparent', border:'none', color:C.textMuted, fontSize:20, cursor:'pointer' }}>ÃÂ¢ÃÂÃÂ</button>
        </div>
        {inp('Titre *', 'title')}
        ...
        <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:12 }}>
          {inp('Client / SociÃÂÃÂ©tÃÂÃÂ©', 'clientName')}
          {inp('TÃÂÃÂ©lÃÂÃÂ©phone', 'clientPhone', 'tel')}
        </div>
        {inp('Courriel client', 'clientEmail', 'email')}
        {inp('Adresse des travaux', 'address')}
        <div style={{ marginBottom:12 }}>
          <label style={{ fontSize:12, fontWeight:700, color:C.textMuted, display:'block', marginBottom:4 }}>DurÃÂÃÂ©e estimÃÂÃÂ©e</label>
        ...
        <label style={{ display:'flex', alignItems:'center', gap:10, marginBottom:20, cursor:'pointer' }}>
          ...
          <span style={{ fontSize:14, color:C.text }}>ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ Entente de service ÃÂ¢ÃÂÃÂ signature requise</span>
        </label>
        <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:10 }}>
          ...
          <button onClick={saveEventForm} disabled={!evForm.title.trim()||!evForm.date||!evForm.time} style={{ padding:12, background:(!evForm.title.trim()||!evForm.date||!evForm.time)?C.inputBg:C.accent, border:'none', borderRadius:8, color:(!evForm.title.trim()||!evForm.date||!evForm.time)?C.textLight:'white', cursor:(!evForm.title.trim()||!evForm.date||!evForm.time)?'not-allowed':'pointer', fontFamily:'inherit', fontSize:14, fontWeight:700 }}>
            {editingEvId ? 'ÃÂ¢ÃÂÃÂ Enregistrer' : '+ CrÃÂÃÂ©er'}
          </button>
        </div>
      </div>
    </div>
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ PAD DE SIGNATURE ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ TEXTE DE L'ENTENTE DE SERVICE ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
const AGREEMENT = {
  fr: [
    { title: "1. PARTIES ET OBJET", text: "La prÃÂÃÂ©sente entente de service (ÃÂÃÂ« Entente ÃÂÃÂ») est conclue entre RÃÂÃÂ©volution Plomberie Inc., titulaire d'une licence RBQ en rÃÂÃÂ¨gle et dÃÂÃÂ©tentrice d'une assurance responsabilitÃÂÃÂ© civile en vigueur (ÃÂÃÂ« l'Entrepreneur ÃÂÃÂ»), et le client identifiÃÂÃÂ© ci-dessous (ÃÂÃÂ« le Client ÃÂÃÂ»). L'Entrepreneur s'engage ÃÂÃÂ  rÃÂÃÂ©aliser les travaux de plomberie dÃÂÃÂ©crits dans la prÃÂÃÂ©sente Entente conformÃÂÃÂ©ment aux rÃÂÃÂ¨gles de l'art et aux codes en vigueur." },
    { title: "2. FRAIS MINIMUM D'APPEL DE SERVICE", text: "Le tarif minimum d'appel de service est de 300,00 $ CAD, non nÃÂÃÂ©gociable. Ce montant comprend les deux (2) premiÃÂÃÂ¨res heures de main-d'ÃÂÃÂuvre sur place par plombier ainsi que des frais fixes de dÃÂÃÂ©placement de 50,00 $ CAD pour tout dÃÂÃÂ©placement dans notre zone de service standard. Ces frais sont exigibles ÃÂÃÂ  l'arrivÃÂÃÂ©e ou ÃÂÃÂ  la fin du service initial et s'appliquent mÃÂÃÂªme si les travaux sont complÃÂÃÂ©tÃÂÃÂ©s en moins de deux heures." },
    { title: "3. MAIN-D'ÃÂÃÂUVRE SUPPLÃÂÃÂMENTAIRE", text: "Toute heure de travail excÃÂÃÂ©dant les deux (2) premiÃÂÃÂ¨res heures incluses dans le tarif minimum sera facturÃÂÃÂ©e ÃÂÃÂ  125,00 $ CAD par heure, par plombier, calculÃÂÃÂ©e par tranches de quinze (15) minutes. Services d'urgence ou hors heures (en dehors de lundi au vendredi, 8 h 00 ÃÂ¢ÃÂÃÂ 16 h 00, ou les jours fÃÂÃÂ©riÃÂÃÂ©s) : majoration de 100 % sur les tarifs standard, communiquÃÂÃÂ©e avant la dÃÂÃÂ©pÃÂÃÂªche dans la mesure du possible." },
    { title: "4. MATÃÂÃÂRIAUX ET PIÃÂÃÂCES", text: "Les matÃÂÃÂ©riaux, piÃÂÃÂ¨ces et ÃÂÃÂ©quipements spÃÂÃÂ©cialisÃÂÃÂ©s requis ne sont pas inclus dans les tarifs de main-d'ÃÂÃÂuvre et sont facturÃÂÃÂ©s sÃÂÃÂ©parÃÂÃÂ©ment. L'Entrepreneur se rÃÂÃÂ©serve le droit d'appliquer une majoration raisonnable sur les matÃÂÃÂ©riaux afin de couvrir l'approvisionnement, la manutention, le transport et la garantie. Une estimation des matÃÂÃÂ©riaux sera fournie lorsque possible, mais le coÃÂÃÂ»t final peut varier selon la disponibilitÃÂÃÂ© et les exigences spÃÂÃÂ©cifiques du chantier." },
    { title: "5. TAXES APPLICABLES", text: "Tous les prix et tarifs mentionnÃÂÃÂ©s dans la prÃÂÃÂ©sente Entente sont exprimÃÂÃÂ©s en dollars canadiens (CAD) et sont sujets ÃÂÃÂ  la taxe sur les produits et services (TPS ÃÂ¢ÃÂÃÂ 5 %) et ÃÂÃÂ  la taxe de vente du QuÃÂÃÂ©bec (TVQ ÃÂ¢ÃÂÃÂ 9,975 %), qui seront ajoutÃÂÃÂ©es ÃÂÃÂ  la facture finale. Le Client est responsable du paiement de toutes les taxes applicables." },
    { title: "6. ESTIMATIONS ET MODIFICATIONS", text: "Toute estimation fournie verbalement ou par ÃÂÃÂ©crit est basÃÂÃÂ©e sur les informations disponibles au moment de l'ÃÂÃÂ©valuation et constitue une approximation sujette ÃÂÃÂ  modification. Si des complications imprÃÂÃÂ©vues ou des travaux additionnels sont dÃÂÃÂ©couverts en cours de chantier, l'Entrepreneur en informera le Client avant de procÃÂÃÂ©der. Tout changement ÃÂÃÂ  la portÃÂÃÂ©e des travaux aprÃÂÃÂ¨s la signature de la prÃÂÃÂ©sente Entente devra ÃÂÃÂªtre autorisÃÂÃÂ© par le Client par ÃÂÃÂ©crit ou par voie ÃÂÃÂ©lectronique (courriel ou message texte consignÃÂÃÂ©)." },
    { title: "7. MODALITÃÂÃÂS DE PAIEMENT", text: "Le paiement de la totalitÃÂÃÂ© des services et des matÃÂÃÂ©riaux est exigible ÃÂÃÂ  la fin des travaux, sauf entente ÃÂÃÂ©crite contraire. Modes de paiement acceptÃÂÃÂ©s : virement Interac, carte de crÃÂÃÂ©dit (Visa/Mastercard), argent comptant. Les chÃÂÃÂ¨ques sont acceptÃÂÃÂ©s jusqu'ÃÂÃÂ  concurrence de 1 000,00 $ CAD; tout chÃÂÃÂ¨que sans provision entraÃÂÃÂ®ne des frais de 50,00 $ CAD. Les factures impayÃÂÃÂ©es aprÃÂÃÂ¨s 5 jours ouvrables sont soumises ÃÂÃÂ  un intÃÂÃÂ©rÃÂÃÂªt de 2 % par mois (24 % par an) calculÃÂÃÂ© ÃÂÃÂ  compter de la date d'ÃÂÃÂ©chÃÂÃÂ©ance. Le Client accepte de rembourser l'Entrepreneur de tous les frais raisonnables engagÃÂÃÂ©s pour le recouvrement des montants en souffrance, incluant les honoraires d'avocat et les frais d'agence de recouvrement." },
    { title: "8. ANNULATION ET NO-SHOW", text: "Toute annulation ou report doit ÃÂÃÂªtre communiquÃÂÃÂ© ÃÂÃÂ  l'Entrepreneur au minimum 24 heures avant l'heure prÃÂÃÂ©vue du rendez-vous. En cas d'annulation tardive (moins de 24 heures) ou si l'Entrepreneur se prÃÂÃÂ©sente et ne peut accÃÂÃÂ©der au chantier ou commencer les travaux en raison de circonstances imputables au Client (personne absente, accÃÂÃÂ¨s impossible, etc.), des frais d'annulation de 200,00 $ CAD seront facturÃÂÃÂ©s au Client." },
    { title: "9. RESPONSABILITÃÂÃÂS DU CLIENT ET ACCÃÂÃÂS", text: "Le Client est responsable de fournir un accÃÂÃÂ¨s sÃÂÃÂ»r, dÃÂÃÂ©gagÃÂÃÂ© et adÃÂÃÂ©quat ÃÂÃÂ  la zone de travail pour les plombiers de l'Entrepreneur. Cela inclut notamment l'absence d'obstructions, de dÃÂÃÂ©bris ou de matiÃÂÃÂ¨res dangereuses, et l'accessibilitÃÂÃÂ© des vannes d'arrÃÂÃÂªt d'eau principales. L'Entrepreneur ne dÃÂÃÂ©placera pas les effets personnels du Client. En cas d'accÃÂÃÂ¨s restreint ou dangereux, l'Entrepreneur se rÃÂÃÂ©serve le droit de facturer le temps d'attente ou de reporter le service, ce qui pourrait entraÃÂÃÂ®ner des frais supplÃÂÃÂ©mentaires." },
    { title: "10. CONDITIONS CACHÃÂÃÂES ET IMPRÃÂÃÂVUS", text: "Le Client reconnaÃÂÃÂ®t que les systÃÂÃÂ¨mes de plomberie comportent souvent des composants cachÃÂÃÂ©s (tuyaux encastrÃÂÃÂ©s dans les murs, planchers ou fondations). L'Entrepreneur n'est pas responsable des conditions prÃÂÃÂ©existantes, des dÃÂÃÂ©fectuositÃÂÃÂ©s ou des dommages non apparents lors de l'ÃÂÃÂ©valuation initiale. Si des conditions imprÃÂÃÂ©vues (bois pourri, moisissures, amiante, dommages structuraux, fuites additionnelles, non-conformitÃÂÃÂ©s au code, etc.) sont dÃÂÃÂ©couvertes, l'Entrepreneur en informera le Client immÃÂÃÂ©diatement. Les travaux nÃÂÃÂ©cessaires pour corriger ces problÃÂÃÂ¨mes feront l'objet d'une cotation distincte." },
    { title: "11. DOCUMENTATION PHOTOGRAPHIQUE", text: "L'Entrepreneur se rÃÂÃÂ©serve le droit de prendre des photographies avant, pendant et aprÃÂÃÂ¨s la rÃÂÃÂ©alisation des travaux ÃÂÃÂ  des fins de documentation interne, de contrÃÂÃÂ´le de la qualitÃÂÃÂ© et de preuve du travail accompli. Ces photographies peuvent ÃÂÃÂªtre utilisÃÂÃÂ©es dans le cadre d'un litige ou d'une rÃÂÃÂ©clamation d'assurance. Aucune image permettant d'identifier personnellement le Client ou sa rÃÂÃÂ©sidence ne sera publiÃÂÃÂ©e sur les rÃÂÃÂ©seaux sociaux ou dans des documents promotionnels sans le consentement ÃÂÃÂ©crit du Client." },
    { title: "12. GARANTIE", text: "L'Entrepreneur garantit sa main-d'ÃÂÃÂuvre pour une pÃÂÃÂ©riode d'un (1) an ÃÂÃÂ  compter de la date d'achÃÂÃÂ¨vement des travaux, spÃÂÃÂ©cifiquement pour le travail exÃÂÃÂ©cutÃÂÃÂ©. Les piÃÂÃÂ¨ces et matÃÂÃÂ©riaux fournis par l'Entrepreneur sont couverts par la garantie du fabricant, le cas ÃÂÃÂ©chÃÂÃÂ©ant, et transmise au Client dans la mesure du possible. Cette garantie est nulle et non avenue en cas de mauvais usage, de nÃÂÃÂ©gligence, de catastrophe naturelle, d'intervention par d'autres corps de mÃÂÃÂ©tier ou de dÃÂÃÂ©fauts prÃÂÃÂ©existants non liÃÂÃÂ©s directement aux travaux effectuÃÂÃÂ©s. La responsabilitÃÂÃÂ© totale de l'Entrepreneur en vertu de la prÃÂÃÂ©sente Entente est limitÃÂÃÂ©e au montant total payÃÂÃÂ© par le Client pour les services fournis. L'Entrepreneur n'est pas responsable des dommages indirects, accessoires, consÃÂÃÂ©cutifs ou punitifs." },
    { title: "13. PERMIS ET INSPECTIONS", text: "Sauf disposition contraire expressÃÂÃÂ©ment convenue par ÃÂÃÂ©crit, l'obtention de tout permis requis et l'organisation des inspections relÃÂÃÂ¨vent de la seule responsabilitÃÂÃÂ© du Client. Si un permis est requis et non obtenu par le Client, l'Entrepreneur se rÃÂÃÂ©serve le droit d'interrompre les travaux jusqu'ÃÂÃÂ  l'obtention des autorisations nÃÂÃÂ©cessaires, sans pÃÂÃÂ©nalitÃÂÃÂ© pour l'Entrepreneur et avec possibilitÃÂÃÂ© de facturation additionnelle." },
    { title: "14. HYPOTHÃÂÃÂQUE LÃÂÃÂGALE DE CONSTRUCTION", text: "Le Client est informÃÂÃÂ© qu'en vertu des articles 2726 et suivants du Code civil du QuÃÂÃÂ©bec, l'Entrepreneur et ses fournisseurs de matÃÂÃÂ©riaux dÃÂÃÂ©tiennent le droit de publier une hypothÃÂÃÂ¨que lÃÂÃÂ©gale de construction sur l'immeuble visÃÂÃÂ© par les travaux en garantie des sommes dues et impayÃÂÃÂ©es. Le Client renonce ÃÂÃÂ  tout recours contre l'Entrepreneur dÃÂÃÂ©coulant de la publication d'une telle hypothÃÂÃÂ¨que en cas de non-paiement." },
    { title: "15. DROIT DE REFUS ET FIN DE SERVICE", text: "L'Entrepreneur se rÃÂÃÂ©serve le droit de refuser ou de mettre fin aux travaux ÃÂÃÂ  tout moment si : l'environnement de travail est jugÃÂÃÂ© dangereux pour la santÃÂÃÂ© ou la sÃÂÃÂ©curitÃÂÃÂ© des plombiers; le Client est non coopÃÂÃÂ©ratif, agressif ou tente d'entraver les travaux; il y a une violation manifeste des prÃÂÃÂ©sentes conditions, incluant des impayÃÂÃÂ©s de services antÃÂÃÂ©rieurs; ou les travaux demandÃÂÃÂ©s excÃÂÃÂ¨dent la compÃÂÃÂ©tence ou les autorisations lÃÂÃÂ©gales de l'Entrepreneur." },
    { title: "16. FORCE MAJEURE", text: "Aucune des parties ne pourra ÃÂÃÂªtre tenue responsable d'un retard ou d'un manquement ÃÂÃÂ  ses obligations rÃÂÃÂ©sultant d'un ÃÂÃÂ©vÃÂÃÂ©nement de force majeure, soit tout ÃÂÃÂ©vÃÂÃÂ©nement imprÃÂÃÂ©visible, irrÃÂÃÂ©sistible et extÃÂÃÂ©rieur ÃÂÃÂ  la volontÃÂÃÂ© des parties (notamment : catastrophe naturelle, incendie, inondation, pandÃÂÃÂ©mie, grÃÂÃÂ¨ve gÃÂÃÂ©nÃÂÃÂ©rale, interruption des services publics ou ordre gouvernemental). La partie affectÃÂÃÂ©e devra notifier l'autre partie sans dÃÂÃÂ©lai et les parties conviendront de nouvelles modalitÃÂÃÂ©s d'exÃÂÃÂ©cution." },
    { title: "17. LOI APPLICABLE ET RÃÂÃÂGLEMENT DES DIFFÃÂÃÂRENDS", text: "La prÃÂÃÂ©sente Entente est rÃÂÃÂ©gie par les lois de la province de QuÃÂÃÂ©bec et du Canada, notamment le Code civil du QuÃÂÃÂ©bec. En cas de litige, les parties s'engagent ÃÂÃÂ  tenter de rÃÂÃÂ©gler leur diffÃÂÃÂ©rend ÃÂÃÂ  l'amiable dans un dÃÂÃÂ©lai de trente (30) jours suivant l'avis ÃÂÃÂ©crit du litige. ÃÂÃÂ dÃÂÃÂ©faut d'entente, tout diffÃÂÃÂ©rend sera soumis aux tribunaux compÃÂÃÂ©tents du district judiciaire de MontrÃÂÃÂ©al, QuÃÂÃÂ©bec, ÃÂÃÂ  l'exclusion de tout autre tribunal." },
    { title: "18. SIGNATURE ÃÂÃÂLECTRONIQUE ET ACCEPTATION", text: "En apposant sa signature ÃÂÃÂ©lectronique sur le prÃÂÃÂ©sent document via l'application de RÃÂÃÂ©volution Plomberie Inc., le Client confirme avoir lu, compris et acceptÃÂÃÂ© intÃÂÃÂ©gralement les termes et conditions de la prÃÂÃÂ©sente Entente de service. La signature ÃÂÃÂ©lectronique ainsi obtenue constitue une signature valide et exÃÂÃÂ©cutoire au sens de la Loi concernant le cadre juridique des technologies de l'information (LCCJTI, RLRQ c C-1.1) du QuÃÂÃÂ©bec et a la mÃÂÃÂªme valeur lÃÂÃÂ©gale qu'une signature manuscrite." },
  ],
  en: [
    { title: "1. PARTIES AND PURPOSE", text: "This Service Agreement (\"Agreement\") is entered into between RÃÂÃÂ©volution Plomberie Inc., a duly licensed plumbing contractor holding a valid RBQ license and general liability insurance (\"Contractor\"), and the client identified below (\"Client\"). The Contractor agrees to perform the plumbing work described in this Agreement in accordance with industry standards and applicable codes." },
    ...
    { title: "3. ADDITIONAL LABOR CHARGES", text: "Labor beyond the initial two (2) hours is billed at $125.00 CAD per hour, per plumber, in 15-minute increments. Emergency or after-hours services (outside MondayÃÂ¢ÃÂÃÂFriday, 8:00 AMÃÂ¢ÃÂÃÂ4:00 PM, or on holidays) are subject to a 100% surcharge on standard labor rates, communicated prior to dispatch where possible." },
    ...
    { title: "14. CONSTRUCTION HYPOTHEC (LEGAL LIEN)", text: "The Client acknowledges that under Articles 2726 et seq. of the Civil Code of QuÃÂÃÂ©bec, the Contractor and its material suppliers have the right to register a legal construction hypothec (lien) on the property for unpaid amounts. The Client waives any claims against the Contractor arising from the registration of such hypothec in the event of non-payment." },
    ...
    { title: "17. GOVERNING LAW AND DISPUTE RESOLUTION", text: "This Agreement is governed by the laws of the Province of QuÃÂÃÂ©bec and Canada, including the Civil Code of QuÃÂÃÂ©bec. In the event of a dispute, the parties agree to attempt amicable resolution within thirty (30) days of written notice. Failing resolution, disputes shall be submitted to the courts of the judicial district of Montreal, QuÃÂÃÂ©bec, to the exclusion of all other jurisdictions." },
    { title: "18. ELECTRONIC SIGNATURE AND ACCEPTANCE", text: "By affixing their electronic signature to this document through the RÃÂÃÂ©volution Plomberie Inc. application, the Client confirms having read, understood, and fully accepted the terms and conditions of this Service Agreement. The electronic signature obtained constitutes a valid and enforceable signature under QuÃÂÃÂ©bec's Act to Establish a Legal Framework for Information Technology (LCCJTI, CQLR c C-1.1) and carries the same legal force as a handwritten signature." },
  ]
};
  ...
  return (
    <div style={{ position:'fixed', inset:0, background:'rgba(0,0,0,0.88)', zIndex:300, display:'flex', alignItems:'center', justifyContent:'center', padding:12 }}>
      <div style={{ background:'white', borderRadius:16, width:'100%', maxWidth:680, maxHeight:'96vh', display:'flex', flexDirection:'column', overflow:'hidden' }}>
        ...
        {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ EN-TÃÂÃÂTE FIXE ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
        <div style={{ padding:'18px 24px 14px', borderBottom:'3px solid #0c2240', flexShrink:0 }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start' }}>
            <img src={logoUrl} alt="RÃÂÃÂ©volution Plomberie" style={{ height:52 }} />
            <div style={{ display:'flex', flexDirection:'column', alignItems:'flex-end', gap:6 }}>
              ...
              <button onClick={onClose} style={{ background:'transparent', border:'none', color:'#888', fontSize:20, cursor:'pointer', lineHeight:1 }}>ÃÂ¢ÃÂÃÂ</button>
            </div>
          </div>
          <div style={{ marginTop:12 }}>
            <div style={{ fontSize:17, fontWeight:800, color:'#0c2240', letterSpacing:.5 }}>{isFr ? 'ENTENTE DE SERVICE' : 'SERVICE AGREEMENT'}</div>
            <div style={{ fontSize:11, color:'#888', marginTop:2 }}>RÃÂÃÂ©volution Plomberie Inc. ÃÂÃÂ· {new Date().toLocaleDateString(isFr?'fr-CA':'en-CA',{year:'numeric',month:'long',day:'numeric'})}</div>
          </div>
          {event && (
            <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'2px 16px', marginTop:10, fontSize:12, color:'#333' }}>
              ...
              {event.time && <div><strong>{isFr?'Date/heure':'Date/time'}:</strong> {event.date} {isFr?'ÃÂÃÂ ':'at'} {event.time}</div>}
            </div>
          )}
        </div>

        {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ CONTENU DÃÂÃÂFILABLE ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
        {sigState.viewOnly ? (
          <div style={{ padding:24, overflowY:'auto', flex:1 }}>
            <div style={{ fontSize:13, color:'#555', marginBottom:12 }}>
              {isFr ? `Entente signÃÂÃÂ©e le ${event?.signedAt ? new Date(event.signedAt).toLocaleDateString('fr-CA',{year:'numeric',month:'long',day:'numeric'}) : 'ÃÂ¢ÃÂÃÂ'}` : `Agreement signed on ${event?.signedAt ? new Date(event.signedAt).toLocaleDateString('en-CA') : 'ÃÂ¢ÃÂÃÂ'}`}
            </div>
          ...
          <>
            ...
            <div style={{ overflowY:'auto', flex:1, padding:'16px 24px' }}>
              ...
              <div style={{ marginTop:12, padding:12, background:'#f0f4ff', borderRadius:8, border:'1px solid #c7d6f7', fontSize:11, color:'#0c2240' }}>
                {isFr ? 'ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ Ce contrat est rÃÂÃÂ©gi par le Code civil du QuÃÂÃÂ©bec et la Loi sur la protection du consommateur (LPC). La signature ÃÂÃÂ©lectronique ci-dessous a la mÃÂÃÂªme valeur lÃÂÃÂ©gale qu\'une signature manuscrite en vertu de la LCCJTI (RLRQ c C-1.1).'
                      : 'ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ This agreement is governed by the Civil Code of QuÃÂÃÂ©bec and the Consumer Protection Act. The electronic signature below has the same legal force as a handwritten signature under QuÃÂÃÂ©bec\'s LCCJTI (CQLR c C-1.1).'}
              </div>
            </div>

            {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ ZONE DE SIGNATURE FIXE EN BAS ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
            <div style={{ padding:'14px 24px 20px', borderTop:'2px solid #e5e7eb', flexShrink:0, background:'#fafafa' }}>
              ...
              <label style={{ display:'flex', alignItems:'flex-start', gap:10, marginBottom:14, cursor:'pointer' }}>
                ...
                <span style={{ fontSize:13, color:'#333', lineHeight:1.5 }}>
                  {isFr ? 'J\'ai lu, compris et j\'accepte intÃÂÃÂ©gralement les termes et conditions de l\'entente de service ci-dessus.' : 'I have read, understood, and fully accept the terms and conditions of the service agreement above.'}
                </span>
              </label>
              ...
              <div style={{ fontSize:11, color:'#aaa', marginTop:4, marginBottom:12 }}>
                {isFr ? 'ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ Signez avec votre doigt ou la souris' : 'ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ Sign with your finger or mouse'}
              </div>
              ...
              <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr 1fr', gap:8 }}>
                ...
                <button onClick={clear} style={{ padding:11, background:'#fee2e2', border:'1px solid #fca5a5', borderRadius:8, color:'#c0392b', cursor:'pointer', fontSize:13 }}>ÃÂ°ÃÂÃÂÃÂÃÂ¯ÃÂ¸ÃÂ {isFr?'Effacer':'Clear'}</button>
                <button onClick={()=>{ if(agreed) onSave(canvasEl); }} disabled={!agreed}
                  ...
                  {agreed ? `ÃÂ¢ÃÂÃÂ ${isFr?'Confirmer':'Confirm'}` : `ÃÂ°ÃÂÃÂÃÂ ${isFr?'Accepter d\'abord':'Accept first'}`}
                </button>
              </div>
            </div>
          </>
